...
\begin{definition}
  ...
  \[\varphi_t(X) = \mathbb{E}[e ^{itX}] = \int_{\Omega} e^{it X} d \mathbb{P}  = \int_{\mathbb{R}} e^{itx} d P_X(x).\]
\end{definition}
...
\begin{prop}
  ...
  \begin{gather*}
    \varphi(t) = \sum_{k=0}^{n} \frac{(it)^{k}}{k!} \mathbb{E}[X ^{k}]+ \frac{(it)^{n}}{n!} \varepsilon_n(t),
  \end{gather*}
