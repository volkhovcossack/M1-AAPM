...
\begin{prop}[Propriété]
  On va démontrer ultérieurement que \(G,H\) sont des sous-[...] et que \(f \in \mathcal{C}^{\infty}\).
\end{prop}
...
\begin{definition}
  Un groupe de Lie est une variété différentielle qui est un groupe tel que le produit \(G \times G \longrightarrow G\) et l'inverse \((\cdot)^{-1} : G \longrightarrow G\) sont des fonctions différentiables.
\end{definition}
...
\begin{definition}\marginnote{22-11-2023}
  ...
  \begin{enumerate}
    \item appelé sous-algèbre de Lie de \(\mathfrak{g}\) et
    \item idéal si \([X,Y] \in \mathfrak{h}\)
...
\begin{definition}
  La somme directe de deux algèbres de Lie \(\mathfrak{g}_1,\mathfrak{g}_2\) est l'algèbre de Lie
  \begin{gather*}
...
\begin{tabular}{|c|c|}
  \hline
  Groupe de Lie & Algèbre de Lie\\
  \hline
  \(GL(n,\mathbb{K})\) & \(\mathfrak{gL}(n,\mathbb{K}) = \mathbb{M}(n,\mathbb{K})\) \\
  \hline
  \(SL(n,\mathbb{K})\) & \(\mathfrak{sL}(n,\mathbb{K}) = \{ X \in \mathbb{M}(n,\mathbb{K}), \operatorname{Tr}(X) = 0 \}\)\\
  \hline
  \(U(n)\) & \(\mathfrak{U}(n) = \{ X ; X ^{*} = - X \}\) \\
  \hline
  \(SU(n)\) & \(\mathfrak{SU}(n) = \{ X ; X ^{*} = - X \text{ et } \operatorname{Tr}(X) = 0\}\) \\
  \hline
  \(O(n)\) & \(\mathfrak{O}(n) = \{ X \in \mathbb{M}(n,\mathbb{R}), X ^{t} = -X \}\) \\
  \hline
  \(SO(n)\) & \(\{ X \in \mathbb{M}(n,\mathbb{R}), X ^{t} = -X \text{ et } \operatorname{Tr}(X) = 0  \}\) \\
  \hline
...
\begin{definition}
  ...
  \[\operatorname{Ad}_{A} : \mathfrak{g} \longrightarrow \mathfrak{g}, \operatorname{Ad}_A(X) = A X A ^{-1}\]

  est appelée l'application adjointe (alias représentation adjointe).
\end{definition}
