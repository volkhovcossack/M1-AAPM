...
Si \(j_s = j_l\) pour \(s \neq l\) \(\overline{\varepsilon} ^{i_1 \dots i_k} = 0 \) par définition.
...
\begin{thm}
  \(\{ \overline{\varepsilon} ^{i_1 \dots i_k}, \text{ pour tout } 1 \leq i_1 \less \dots \less i_k \leq n \} \)

  forme une base pour \(\Lambda ^{k}(E)\).
\end{thm}
...
Par convention, \(\operatorname{dim}(\Lambda ^{0}(E)) = \mathbb{R}\), \(\Lambda ^{k}(E) = \{ 0 \} \) si \(k \less 0\) et \[\operatorname{dim}(\Lambda ^{k}(E)) = \frac{n!}{1!(n-1)!} = n \text{ et } \operatorname{dim}(\Lambda ^{n}(E)) = \frac{n!}{(n-n)! 0!} = 1. \]
