...
\begin{thm}[Levy]
  ...
  \begin{enumerate}
    \item Supposons que \(X_k\) converge en loi vers la variable aléatoire \(X\) définie sur \((\Omega, \mathscr{A}, \mathbb{P})\). Alors
    ...
    \[X_k \stackrel{\mathscr{L}}{\longrightarrow} \mu.\]
...
\begin{proof}
  \begin{gather*}
    \varphi _{X_k}(t) = \int_{\mathbb{R}}^{} \underset{\substack{\text{continue} \\ \text{bornée}}}{e^{itx_k}} d P _{X_k}(x_k)  = \int_{\mathbb{R}} e^{itx} d P_X(x).
  \end{gather*}
\end{proof}
